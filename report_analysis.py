...
name1 = 'center_distance_results'
name2 = 'ssim_not_inv_results'
...
for id in name_id:
    ...
    plt.savefig('AOPC_plots/'+ name1 + '/AOPC' + name1 + '_img' + str(id) + '.png')
    plt.clf()

    plt.plot(result2[id][1])
    plt.savefig('AOPC_plots/'+ name1 + '/AOPC' + name2 + '_img' + str(id) + '.png')
    plt.clf()
